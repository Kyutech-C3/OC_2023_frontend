...
var ASM_CONSTS = {
  4030372: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4030427: function($0) {performance.now = function() { return $0; };},  
 4030475: function($0) {performance.now = function() { return $0; };},  
 4030523: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4030578: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4030639: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4030703: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _DataCallBack(UUID,PosX,PosY,PosZ,RotX,RotY,RotZ ,AnimName, AnimTime) {
      window.dispatchReactUnityEvent("DataCallBack", UTF8ToString(UUID), PosX,PosY,PosZ,RotX,RotY,RotZ,UTF8ToString(AnimName),AnimTime);
    }
  ...
  function _ModalCall(Genre) {
      window.dispatchReactUnityEvent("ModalCall", UTF8ToString(Genre));
    }

  function _ModalClose(Genre) {
      window.dispatchReactUnityEvent("ModalClose", UTF8ToString(Genre));
    }
...
/** @type {function(...*):?} */
var dynCall_viiiffffffifi = Module["dynCall_viiiffffffifi"] = createExportWrapper("dynCall_viiiffffffifi");

/** @type {function(...*):?} */
var dynCall_viiffffffifi = Module["dynCall_viiffffffifi"] = createExportWrapper("dynCall_viiffffffifi");

/** @type {function(...*):?} */
var dynCall_viffffffifi = Module["dynCall_viffffffifi"] = createExportWrapper("dynCall_viffffffifi");
